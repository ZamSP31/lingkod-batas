...
/**
 * "Account" (Fig. 3.28) — profile details and password management.
 * Reuses the same field-level validators as Login/Register so the
 * rules stay identical everywhere a password is set. Password fields
 * are optional here: leaving all three blank just saves the profile
 * fields and leaves the password untouched.
 */
function AttorneyAccountPage() {
  ...
  function validate(): FormErrors {
    ...
    // attorney starts filling any one of the three — leaving all
    // three blank means "don't change my password."
  ...
  function handleDeleteAccount() {
    ...
    // (matching the Logout modal's design, Fig. 3.36) once that
    // component exists — this is a functional stand-in for now.
    ...
    <div className="max-w-2xl">
      ...
      <div className="mt-6">
        <Card
          ...
          description="Permanently removes your account and all uploaded contracts. This cannot be undone."
          tone="danger"
        >
          <Button
            type="button"
