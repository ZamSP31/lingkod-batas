  ...
  return (
    <div className="flex min-h-screen flex-col bg-parchment font-sans text-ink">
      ...
      <main className="flex-1">
        ...
        <section className="mx-auto grid max-w-[1360px] grid-cols-1 items-center gap-12 px-6 py-14 md:grid-cols-[1.05fr_0.95fr] md:gap-16 md:px-14 md:py-24">
          <div className="flex flex-col">
            <div className="mb-5.5 flex items-center gap-2.5 font-mono text-xs font-medium tracking-[0.08em] text-maroon uppercase">
              ...
              The Pinoy Street Lawyer Advocacy
            </div>
            ...
            <h1 className="mb-6 font-serif text-[40px] font-medium leading-[1.06] tracking-[-0.015em] text-navy-deep sm:text-[52px]">
              ...
              <br />
              Every judgment still{" "}
              <em className="font-serif italic text-maroon font-medium">
                yours
              </em>
              .
            </h1>
            ...
            <p className="mb-9 max-w-[460px] text-[17.5px] leading-[1.6] text-ink-soft">
              Lingkod Batas reads contracts against the Labor Code and DOLE
              issuances, flags what deserves a second look, and puts it in front
              of you — never the client — for the final call.
            </p>
          ...
          <div className="relative">
            <div className="relative rotate-[0.6deg] rounded-[6px] border border-line bg-white p-7 sm:p-8 shadow-2xl">
              {/* Wax-seal stamp */}
              <svg
                className="absolute -right-5 -top-5 h-20 w-20 drop-shadow-[0_6px_10px_rgba(176,141,79,0.35)]"
                viewBox="0 0 100 100"
              >
                <circle
                  cx="50"
              ...
              <div className="text-[14.5px] leading-[1.75] text-[#3a352d]">
                ...
                upon fifteen (15) days' written notice to the Employee, without
                further obligation..."
              </div>
              ...
              <div className="mt-4 flex gap-2.5 rounded-r-[4px] border-l-[2.5px] border-maroon bg-parchment p-3">
                <svg
                  viewBox="0 0 24 24"
                  fill="none"
                  className="mt-0.5 h-3.5 w-3.5 shrink-0 text-maroon"
                >
                  <path
                ...
                <div className="text-[12.5px] leading-[1.55] text-ink-soft">
                  <b className="font-semibold text-ink">
                    Possible just-cause conflict.
                  </b>{" "}
                  Notice period alone may not satisfy dismissal requirements.
              ...
              <div className="mt-5 flex items-center justify-between border-t border-dashed border-line pt-4">
                <div className="flex items-center gap-2 text-[12.5px] text-ink-soft">
                  ...
                  Reviewed by Atty. Danielito Jimenez (Pinoy Street Lawyer)
                </div>
        ...
        <section
          id="how"
          className="mx-auto max-w-[1360px] px-6 py-20 md:px-14 md:py-24 border-t border-line"
        >
          ...
          <div className="relative pl-2">
            ...
            <div className="relative flex gap-7 pb-14">
              ...
              <div className="pt-1.5">
                ...
                <p className="max-w-[480px] text-[14.5px] leading-[1.65] text-ink-soft">
                  PDF or scanned image, OCR'd automatically. Nothing is shown to
                  the client beyond confirmation of receipt.
                </p>
              </div>
            </div>
            ...
            <div className="relative flex gap-7 pb-14">
              ...
              <div className="pt-1.5">
                ...
                <p className="max-w-[480px] text-[14.5px] leading-[1.65] text-ink-soft">
                  Each clause is compared to the Labor Code and relevant DOLE
                  issuances. Risk flags are drafted, cited, and queued — visible
                  only to the assigned attorney.
                </p>
              </div>
            </div>
            ...
            <div className="relative flex gap-7">
              ...
              <div className="pt-1.5">
                ...
                <p className="max-w-[480px] text-[14.5px] leading-[1.65] text-ink-soft">
                  You approve the final report clause by clause. Only what you
                  sign off on reaches the client.
                </p>
              </div>
            </div>
          </div>
        ...
        {/* ===== PINOY STREET LAWYER ADVOCACY SECTION ===== */}
        <section
          id="attorneys"
          className="mx-auto max-w-[1360px] px-6 py-20 md:px-14 md:py-24 border-t border-line scroll-mt-20"
        >
          <div className="mb-14 max-w-[780px]">
            <div className="mb-3.5 flex items-center gap-2.5 font-mono text-xs font-semibold tracking-[0.08em] text-maroon uppercase">
              <span className="h-[1px] w-[22px] bg-maroon" />
              The Advocacy · Pinoy Street Lawyer
            </div>
            <h2 className="font-serif text-[36px] font-medium leading-[1.15] tracking-[-0.01em] text-navy-deep sm:text-[42px]">
              Democratizing Philippine labor justice for every Filipino worker.
            </h2>
            <p className="mt-4 text-[16.5px] leading-[1.65] text-ink-soft">
              Founded on the grassroots advocacy of{" "}
              <strong>Atty. Danielito Jimenez</strong> — known in communities
              and online as the <em>"Pinoy Street Lawyer"</em> — Lingkod Batas
              bridges the gap between complex legal jargon and everyday workers,
              ensuring no employee signs away their statutory rights in the
              dark.
            </p>
          </div>

          <div className="grid grid-cols-1 gap-6 md:grid-cols-[1.35fr_1fr]">
            {/* Main Advocacy Workspace Card */}
            <div className="flex flex-col justify-between rounded-[10px] border border-line bg-navy-deep p-8 text-parchment shadow-xl">
              <div>
                <div className="mb-4 flex items-center justify-between">
                  <span className="font-mono text-[11px] font-semibold tracking-[0.08em] text-gold uppercase">
                    Atty. Danielito Jimenez's Review Portal
                  </span>
                  <span className="rounded-full bg-gold/15 px-3 py-0.5 font-mono text-[10px] font-medium text-gold">
                    IBP Roll No. 67890
                  </span>
                </div>
                <h3 className="mb-3.5 max-w-[420px] font-serif text-[26px] font-medium leading-[1.25] text-parchment">
                  AI-augmented triage for everyday workers who need guidance
                  most.
                </h3>
                <p className="max-w-[440px] text-[14.5px] leading-[1.65] text-parchment/75">
                  Contracts from delivery riders, BPO call center staff,
                  probationary employees, and freelancers are organized by
                  urgency — empowering counsel to deliver timely, actionable
                  advice before employment agreements are signed.
                </p>
              </div>

              {/* Realistic Philippine Worker Contracts Preview */}
              <div className="mt-8 rounded-[8px] border border-parchment/15 bg-parchment/[0.06] p-4.5">
                <div className="mb-2 text-[10.5px] font-mono tracking-wider text-parchment/50 uppercase">
                  Active Worker Triage Queue
                </div>
                <div className="flex items-center justify-between border-b border-parchment/10 py-2.5 text-[12.5px]">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-mono text-parchment text-[12px]">
                      bpo_customer_support_contract.pdf
                    </span>
                  </div>
                  <span className="rounded-full bg-maroon/30 px-2.5 py-0.5 font-mono text-[10px] text-[#E39AA8] font-medium">
                    2 high-risk clauses
                  </span>
                </div>
                <div className="flex items-center justify-between border-b border-parchment/10 py-2.5 text-[12.5px]">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-mono text-parchment text-[12px]">
                      logistics_delivery_rider_agreement.pdf
                    </span>
                  </div>
                  <span className="rounded-full bg-gold/20 px-2.5 py-0.5 font-mono text-[10px] text-gold font-medium">
                    Under review
                  </span>
                </div>
                <div className="flex items-center justify-between py-2.5 text-[12.5px]">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-mono text-parchment text-[12px]">
                      probationary_developer_contract.pdf
                    </span>
                  </div>
                  <span className="rounded-full bg-[#7CC28C]/20 px-2.5 py-0.5 font-mono text-[10px] text-[#8FD49E] font-medium">
                    Released to worker
                  </span>
                </div>
              </div>
            ...
            <div className="flex flex-col gap-5">
              <div className="rounded-[10px] border border-line bg-white p-7 shadow-xs">
                <div className="mb-2 flex items-center justify-between">
                  <span className="font-serif text-[40px] font-medium leading-none text-navy-deep">
                    100%
                  </span>
                  <span className="rounded-full bg-navy/10 px-2.5 py-0.5 font-mono text-[10.5px] font-semibold text-navy uppercase">
                    Attorney Signed
                  </span>
                </div>
                <h4 className="font-serif text-[17px] font-medium text-navy-deep mb-1">
                  Human-in-the-Loop Integrity
                </h4>
                <div className="text-[13.5px] leading-[1.6] text-ink-soft">
                  True to the Pinoy Street Lawyer ethos, AI never provides
                  standalone legal advice. Every statutory finding is vetted,
                  annotated with practical guidance, and signed off by Atty.
                  Danielito Jimenez.
                </div>
              </div>
              ...
              <div className="rounded-[10px] border border-line bg-white p-7 shadow-xs">
                <div className="mb-2 flex items-center justify-between">
                  <span className="font-serif text-[40px] font-medium leading-none text-maroon">
                    15+
                  </span>
                  <span className="rounded-full bg-maroon/10 px-2.5 py-0.5 font-mono text-[10.5px] font-semibold text-maroon uppercase">
                    Labor Standards
                  </span>
                </div>
                <h4 className="font-serif text-[17px] font-medium text-navy-deep mb-1">
                  Philippine Statutory Grounding
                </h4>
                <div className="text-[13.5px] leading-[1.6] text-ink-soft">
                  Automated checks ground clauses directly against the
                  Philippine Labor Code, DOLE Department Orders, and Supreme
                  Court jurisprudence to prevent predatory employment
                  conditions.
                </div>
              </div>
            </div>
          ...
          <div className="mx-auto grid max-w-[1360px] grid-cols-1 items-center gap-14 px-6 py-24 md:grid-cols-[0.9fr_1.1fr] md:px-14">
            <div>
              ...
              <p className="mt-4.5 max-w-[440px] text-[15.5px] leading-[1.7] text-parchment/65">
                Every upload, flag, and override is logged. Nothing leaves the
                platform without your name on it.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-[1px] overflow-hidden rounded-[8px] bg-parchment/12">
              <div className="bg-navy-deep p-6">
                <svg
                  viewBox="0 0 24 24"
                  fill="none"
                  className="mb-3.5 h-5 w-5 text-gold"
                >
                  <rect
                    x="4"
                    y="10"
                ...
                <p className="text-[12.5px] leading-[1.6] text-parchment/55">
                  Contracts and reports are encrypted in storage and in transit,
                  end to end.
                </p>
              </div>
              ...
              <div className="bg-navy-deep p-6">
                ...
                <p className="text-[12.5px] leading-[1.6] text-parchment/55">
                  Data handling follows the Data Privacy Act, with audit logs on
                  every access.
                </p>
              </div>
              ...
              <div className="bg-navy-deep p-6">
                ...
                >
                  ...
                  />
                  <path
                    d="M5 21C5 16.5 8 14 12 14C16 14 19 16.5 19 21"
                    stroke="currentColor"
                    strokeWidth="1.6"
                  />
                </svg>
                ...
                <p className="text-[12.5px] leading-[1.6] text-parchment/55">
                  Clients never see raw AI output — only the report their
              ...
              <div className="bg-navy-deep p-6">
                ...
                <p className="text-[12.5px] leading-[1.6] text-parchment/55">
                  Every override and approval is timestamped and attributed to
        ...
        <section className="mx-auto max-w-[760px] px-6 py-24 text-center">
          <div className="mb-3.5 inline-flex items-center gap-2 font-mono text-xs font-semibold tracking-[0.08em] text-maroon uppercase">
            <span className="h-[1px] w-[22px] bg-maroon" />
            Join the Movement
          </div>
          <h2 className="mb-4.5 font-serif text-[36px] font-medium leading-[1.2] text-navy-deep sm:text-[40px]">
            Fighting for worker rights, one contract at a time.
          </h2>
          <p className="mb-8.5 text-base text-ink-soft max-w-[560px] mx-auto">
            Lingkod Batas powers the Pinoy Street Lawyer advocacy led by Atty.
            Danielito Jimenez. Have an employment contract you are about to
            sign? Submit it for an AI-assisted, attorney-verified review today.
          </p>
